...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion modal-backdrop" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="content-wrapper" class="d-flex flex-column">
                    ...
                    <div id="content">
                        ...
                        <!-- Topbar -->
                        <nav class="navbar bg-white navbar-expand navbar-white topbar mb-4 static-top shadow fixed-top" id="menu">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="#">Leer todos los comentarios</a>
    </div>
</li>
...
<li class="nav-item dropdown no-arrow">
    ...
    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Felix Javier</span>
...
<!--  -->
<a class="dropdown-item active" href="#" id="id-sun">
    <i class="fas fa-sun fa-sm fa-fw mr-2 text-gray-400"></i>
       Mode White
</a>
<a class="dropdown-item" href="#" id="id-moon">
...
<!-- Begin Page Content -->
<div class="container-fluid" style="padding-top: 6%; padding-left: 20%;" id="cuerpo">
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        ...
        <div class="card shadow mb-4">
            ...
            <!-- Footer -->
            <footer class="sticky-footer bg-white" style="padding-left: 20%">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy;<a target="_blank" href="http://www.utdelacosta.edu.mx/">Ut de La Costa</a></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
...
document.getElementById('id-sun').onclick = function(){
  ...
  document.getElementById('menu').classList.add('bg-white')
    // cuerpo
  document.getElementById('cuerpo').classList.remove('bg-dark')
  document.getElementById('cuerpo').classList.add('bg-white')
...
document.getElementById('id-moon').onclick = function(){
  ...
  // cuerpo
  document.getElementById('cuerpo').classList.remove('bg-white')
  document.getElementById('cuerpo').classList.add('bg-dark')
